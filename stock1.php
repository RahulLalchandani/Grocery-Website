...
$pstock="";
$pname=$_POST["pname"];
$query = 'SELECT * FROM product_details WHERE pname="'.$pname.'"';
		...
		<div class="privacy about">
			...
			<center>
				<div>
					...
					<form action="stock.php" method="post"></br>
					<?php
					  echo '<B>
					  Prod Name:<input type="text" name="pname" id="pname" placeholder="PRODUCT NAME" value="'.$pname.'" size="30" style="height:30px"></br></br>
					  P_Category<input type="text" name="category" id="category" placeholder="PRODUCT CATEGORY" value="'.$category.'" size="30" style="height:30px"></br></br> 					 
					  Prod Price <input type="text" name="price" id="price" placeholder="PRODUCT PRICE" size="30" value="'.$price.'" style="height:30px"></br></br>
					  Dis_Amount<input type="text" name="dis_amt" id="dis_amt" placeholder="DISCOUNT AMOUNT" size="30" value="'.$dis_amt.'" style="height:30px"></br></br>
					  Prod Stock<input type="text" name="pstock" id="pstock"placeholder="STOCK" size="30" value="'.$pstock.'" style="height:30px"></br></br>
					  <input type="submit" value="UPDATE" style="height:30px;width:200px;font-size:20px"></B>';
					?>
					</form>
				  </div>
				</div>
