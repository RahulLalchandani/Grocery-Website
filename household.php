	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				$query = "select * from product_details where category = 'household'";
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
										    <img style="width:150px;height:180px;" src="'.$rows['pimage'].'" alt=" " class="img-responsive" width="140" height="140" /></a>
											<p>'.$rows['pname'].'</p>
