...
<div class="container">
     <div id ="orderTble">
	 <h1><center>Thank you For Shopping</center></h1><br>
  ...
  <table class="table">
   ...
   <h2 align="right">Do Shopping Again</h2>
					
					<form action="thanx.php" method="post">
					<input type = "button" value="CONFIRM" class="button" style="margin-left:520px" onClick= "billing();">
					</form>
