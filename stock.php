...
$pstock=$_POST["pstock"];
$pname=$_POST["pname"];
$query = 'UPDATE `product_details` SET `category`="'.$category.'",`price`="'.$price.'",`dis_amt`="'.$dis_amt.'",`pstock`="'.$pstock.'" WHERE `pname`="'.$pname.'"';
		...
		<div class="privacy about">
			...
			<center>
				<div>
					...
					<form action="stock1.php" method="post"></br>
					  <B><input type="text" id="pname" name="pname" placeholder="PRODUCT NAME" required=" " size="30" style="height:30px"></br></br>
					  <input type="submit" value="SEARCH" style="height:30px;width:200px;font-size:20px"></B>
