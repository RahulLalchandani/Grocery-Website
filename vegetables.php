...
<!-- banner -->
			...
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						<img src="images/18.jpg" alt=" " class="img-responsive" width="400" height="266" />
						<div class="mask">
							<h4>Grocery Store</h4>
						</div>
					</div>
					...
					<ol>
						<li>they are really fresh and sweet</li>
						<li>Directly from the fields</li>
						<li>both seedless and with seed available</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						<img src="images/19.jpg" alt=" " class="img-responsive" width="400" height="266" />
						<div class="mask">
							<h4>Grocery Store</h4>
						</div>
					</div>
					<h4>Dry Fruits</h4>
					<ol>
						<li>fresh and 100% trusted quality</li>
						<li>high quality product</li>
						<li>packed in nitrogen packinft</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						<img src="images/20.jpg" alt=" " class="img-responsive" width="400" height="266" />
						<div class="mask">
							<h4>Grocery Store</h4>
						</div>
					</div>
					<h4>Vegetables</h4>
					<ol>
						<li>green and leafy</li>
						<li>all kinds of vegetables</li>
						<li>freshly available.</li>
					</ol>
				</div>
	...
	<!-- start of product-->
				...
				$query = "select * from product_details where category = 'vegetables'";
